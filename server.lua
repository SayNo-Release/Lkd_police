		...
		for i=1, #PlayerData.inventory, 1 do
			if PlayerData.inventory[i].name == 'ppa' then
				if PlayerData.inventory[i].count < 1 then
					...
					TriggerClientEvent('esx:showNotification', _source,  "Vous avez acheter le permis de ~g~port d'arme")
				else
...
TriggerEvent('esx_phone:registerNumber', 'police', ('alert_police'), true, true)
